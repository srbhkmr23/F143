...
class AddNewSpeaker extends Component {
  constructor(props) {
    super(props);
    this.state = {
      speakerName: '',
    ...
    this.onAddSpeakerFormSubmit = this.onAddSpeakerFormSubmit.bind(this);
  ...
  submitForm() {
    ...
    if (this.props.userInfo && this.props.userInfo.id) {
      ...
      innovecsysApiService('addSpeaker', sendDataObj).then(response => {
          ...
          <div className="events-page">
            ...
            <div className="events-page-footer-add-new">
              <button
                ...
                type="button"
                onClick={this.onAddSpeakerFormSubmit}
              >
                ADD
              </button>
...
export default connect(mapStateToProps, mapDispatchToProps)(AddNewSpeaker);
