...
class AddNewSponsor extends Component {
  constructor(props) {
    super(props);
    this.state = {
      sponsorName: '',
    ...
    this.onAddSponsorFormSubmit = this.onAddSponsorFormSubmit.bind(this);
  ...
  updateProfileImage(imgData, newImage) {
    this.setState({
      bannerImageSource: imgData !== '' ? imgData : this.state.bannerImageSource
    });
  ...
  removeEventBanner(AWSFileURL) {
    ...
    this.deleteSpeakerImageFromAWS(AWSFileURL);
  }
  ...
  submitForm() {
    ...
    if (this.props.userInfo && this.props.userInfo.id) {
      ...
      innovecsysApiService('addSponsor', sendDataObj).then(response => {
          ...
          <div className="events-page">
                ...
                {/*<div className="col-md-9">
                  ...
                  >
                    ...
                    <textarea
                      ...
                      onFocus={event => this.onControlFocus(event)}
                      onChange={event => this.handleUserInput(event)}
                      onBlur={e => this.validateAboutSponsor(this.state.aboutSponsor)}
            ...
            <div className="events-page-footer">
              <button
                ...
                type="button"
                onClick={this.onAddSponsorFormSubmit}
              >
                ADD
              </button>
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators(
    { showLoader, hideLoader, actionDashboardData },
    dispatch
  );
};

export default connect(mapStateToProps, mapDispatchToProps)(AddNewSponsor);
